...
| 1 | Other failure | `sharingViolation`, `nameCollision`, `directoryNotEmpty`, `fileIsADirectory`, `notADirectory`, `diskFull`, `objectNameInvalid`, `endOfFile`, `unsupported`, `protocolError`, `invalidRecursion`, and uncategorized non-usage errors |
