...
| reparse point metadata / target | MS-FSCC FileAttributeTagInformation, FSCTL_GET_REPARSE_POINT | `SMB2ReadCodecs.swift`, `SMBFileStat`, `SMBee.readlink`, `smbcli readlink` | yes | yes | no | no | underverified | Tag metadata is covered by Samba E2E. Symlink/mount-point/LX target decode has unit coverage; real-server readlink smoke remains. DFS/NFS reparse data stays opaque by specification. |
