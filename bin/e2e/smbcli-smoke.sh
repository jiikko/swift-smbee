...
SMB_PASSWORD="${SMBEE_E2E_PASSWORD}" "${SMBCLI}" stat --json "${SMB_URL}/${SMBEE_E2E_SMOKE_ROOT}/file.txt" | grep -F '"allocationSize"'
SMB_PASSWORD="${SMBEE_E2E_PASSWORD}" "${SMBCLI}" lock --offset 0 --length 1 --json "${SMB_URL}/${SMBEE_E2E_SMOKE_ROOT}/file.txt" | grep -F '"command":"lock"'
